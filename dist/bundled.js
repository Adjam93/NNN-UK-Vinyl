...
/***/ "./assets/js/modules/GridListToggle.js":
/*!*********************************************!*\
  !*** ./assets/js/modules/GridListToggle.js ***!
  \*********************************************/
...
/* harmony default export */ __webpack_exports__["default"] = (GridListToggle);
...
class MobileMenu {
  constructor() {
    ...
    this.mobileMenu = document.querySelector(".mobile-menu"); //this.siteHeader = document.querySelector(".site-header")
...
/***/ "./assets/js/modules/RecordCategorySelect.js":
/*!***************************************************!*\
  !*** ./assets/js/modules/RecordCategorySelect.js ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
class RecordCategorySelect {
  ...
  async getCategoryResults(dataAttribute) {
    try {
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(search_vars.root_url + "/wp-json/product/v1/category?cat_slug=" + dataAttribute);
...
/* harmony default export */ __webpack_exports__["default"] = (RecordCategorySelect);

/***/ }),

/***/ "./assets/js/modules/RecordSearch.js":
/*!*******************************************!*\
  !*** ./assets/js/modules/RecordSearch.js ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
class RecordSearch {
    ...
    if (this.searchField.value != this.previousValue) {
      ...
      if (this.searchField.value) {
        ...
        if (this.searchField.value.length < 3) {
          this.resultsDiv.classList.add("show-results");
          this.searchOverlay.style.display = "flex"; // this.resultsDiv.innerHTML = '<div class="spinner-loader">Searching... (please enter at least 3 or more characters)</div>'

          this.resultsDiv.innerHTML = ''; // this.resultsDiv.insertAdjacentHTML('beforeend', '<div class="spinner-loader">Searching... (please enter at least 3 or more characters)</div>')
  ...
  async getSearchResults() {
    try {
      ...
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(search_vars.root_url + "/wp-json/product/v1/search?term=" + this.searchField.value); // const response = await fetch("http://movie-api.local/wp-json/wp/v2/movie?categories=" + dataAttribute)
      ...
      this.resultsDiv.innerHTML = `
            ...
            ${records.map(record => `<div class="container">
...
/* harmony default export */ __webpack_exports__["default"] = (RecordSearch);

/***/ }),

/***/ "./assets/js/modules/ShopFilters.js":
/*!******************************************!*\
  !*** ./assets/js/modules/ShopFilters.js ***!
  \******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
class ShopFilters {
  ...
  observerCallback(mutationsList, observer) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".mobile-active-filters").empty();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".awf-active-badges-container").clone(true, true).contents().appendTo('.mobile-active-filters');
  }
...
/* harmony default export */ __webpack_exports__["default"] = (ShopFilters);

/***/ }),

/***/ "./assets/js/modules/StickySearch.js":
/*!*******************************************!*\
  !*** ./assets/js/modules/StickySearch.js ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
class StickySearch {
  ...
  events() {
    ...
    document.addEventListener('click', function (e) {
      ...
      if (document.querySelector(".header-search-results").contains(e.target) || document.getElementById("records-search").contains(e.target) || document.activeElement.id == "records-search") {// Clicked in box
...
/* harmony default export */ __webpack_exports__["default"] = (StickySearch);
...
/*!***************************!*\
  ...
  \***************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_MobileMenu_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/MobileMenu.js */ "./assets/js/modules/MobileMenu.js");
/* harmony import */ var _modules_StickySearch_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/StickySearch.js */ "./assets/js/modules/StickySearch.js");
/* harmony import */ var _modules_RecordSearch__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/RecordSearch */ "./assets/js/modules/RecordSearch.js");
/* harmony import */ var _modules_RecordCategorySelect__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/RecordCategorySelect */ "./assets/js/modules/RecordCategorySelect.js");
/* harmony import */ var _modules_ShopFilters__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/ShopFilters */ "./assets/js/modules/ShopFilters.js");
/* harmony import */ var _modules_GridListToggle__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/GridListToggle */ "./assets/js/modules/GridListToggle.js");
...
new _modules_MobileMenu_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
new _modules_StickySearch_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
new _modules_RecordSearch__WEBPACK_IMPORTED_MODULE_2__["default"]();
new _modules_RecordCategorySelect__WEBPACK_IMPORTED_MODULE_3__["default"]();
new _modules_ShopFilters__WEBPACK_IMPORTED_MODULE_4__["default"]();
new _modules_GridListToggle__WEBPACK_IMPORTED_MODULE_5__["default"]();
}();
/******/ })()
;
